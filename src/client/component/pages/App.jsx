...
function App(props) {
  ...
  return (
    <div>
      ...
      <Footer>{'(c) 2018 '}<a className='nerdakademie' href='https://nerdakademie.xyz'>{'Nerdakademie'}</a> | <a className='nerdakademie' href='https://github.com/nerdakademie/stupa-wahltool'>{'v1.3.4'}</a></Footer>
    </div>
  );
}
