  ...
  return (
    <div>
      ...
      <p>{'Hier kannst du für die aufgestellten Kandidaten deine Stimme abgeben!'} <br />
        ...
        <p>{'Der Zeitraum, in welchem du dich aufstellen kannst, ist: '}<b>{'Sonntag, 19.03. 10:00 Uhr – Donnerstag, 23.03. 10:00 Uhr.'}</b></p>
        <p>{'Der Wahlzeitraum ist: '}<b>{'Donnerstag, 23.03. 10:00 Uhr – Montag, 27.03. 10:00 Uhr.'}</b></p>
